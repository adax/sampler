package com.haulmont.sampler.web.ui.charts.events.legend;
...
public class ChartLegendFrame extends AbstractFrame {
    ...
    public void init(Map<String, Object> params) {
        chart.addLegendItemHideListener(event ->
                showNotification("LegendItemHideEvent", itemInfo(event.getItem()), NotificationType.HUMANIZED_HTML));
        chart.addLegendItemShowListener(event ->
                showNotification("LegendItemShowEvent", itemInfo(event.getItem()), NotificationType.HUMANIZED_HTML));
    }
